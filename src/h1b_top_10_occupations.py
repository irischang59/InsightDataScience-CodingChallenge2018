...
# select 'CASE_STATUS' & 'SOC_NAME' columns
arr2 = arr1[:,[2,24]]
...
textfile1 = open('textfile1.txt', 'w')
...
textfile2 = open('textfile2.txt', 'w')
...
textfile3 = open('textfile3.txt', 'w')
textfile3.write(ls_3_new)
textfile3.close()

# concatenate text files line by line and output the final text file to the desired directory
textfile1 = open("textfile1.txt", "r")
textfile2 = open("textfile2.txt", "r")
textfile3 = open("textfile3.txt", "r")
